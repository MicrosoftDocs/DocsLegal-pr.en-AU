...
-   only using sub-processors with the consent of the controller and remaining liable for sub-processors;
-   processing personal data only on instructions from the controller, including with regard to transfers;
-   ensuring that persons who process personal data are committed to confidentiality;
-   implementing appropriate technical and organisational measures to ensure a level of personal data security appropriate to the risk;
-   assisting the controller in its obligations to respond to data subjects’ requests to exercise their GDPR rights;
-   meeting the GDPR’s breach notification and assistance requirements;
-   assisting the controller with data protection impact assessments and consultation with supervisory authorities; 
-   deleting or returning personal data at the end of provision of services; and
-   supporting the controller with evidence of compliance with the GDPR.
